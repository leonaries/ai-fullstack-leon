      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          <div>
            ...
            >
              9 年 Web / 全栈经验，聚焦 AI 应用架构与全链路交付。擅长 Prompt Engineering、RAG、Agent 工作流、LLM 推理优化与 AI 前端交互，把大模型能力接入真实业务链路。
            </motion.p>
            ...
            >
              {['Prompt', 'RAG', 'AI Agent', 'LangGraph', 'FastAPI', 'Next.js'].map((tag) => (
                <span
                  key={tag}
